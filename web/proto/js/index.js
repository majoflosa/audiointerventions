...
class Tabs {
  ...
  setDomElements() {
      this.dom.header = this.dom.el.querySelector('.tabs__header');
      this.dom.tabs = this.dom.el.querySelectorAll('.tabs__tab');
      this.dom.content = this.dom.el.querySelector('.tabs__content');
      this.dom.panels = this.dom.el.querySelectorAll('.tabs__panel');
  }
